...
export const lembagaRegistrationSchema = z
  .object({
    ...
    picPhone: z.string().max(20, "Nomor telepon maksimal 20 karakter").optional().or(z.literal("")),
    ...
    aktaYayasanUrl: z.string().url().optional().or(z.literal("")),
    aktaYayasanPublicId: z.string().optional().or(z.literal("")),
    skKemenkumhamUrl: z.string().url().optional().or(z.literal("")),
